...
void Syllabus::DisplaySyllabus()
{
	...
	while (count < 7) {
		...
		std::vector<Syllabus_a> assignments = LoadSyllabus(FileName);
		for (const Syllabus_a& assignment : assignments) {
...
void Syllabus::BindEventHandlers(int f)
{
}
